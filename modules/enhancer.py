...
from modules.decoder.nsf_hifigan.models import load_model
from modules.decoder.nsf_hifigan.nvSTFT import STFT
    ...
    def enhance(self,
        ...
        if sample_rate == adaptive_sample_rate:
            ...
            if key_str not in self.resample_kernel:
                self.resample_kernel[key_str] = Resample(sample_rate, adaptive_sample_rate,
        ...
        if adaptive_factor != 0:
            ...
            if key_str not in self.resample_kernel:
                self.resample_kernel[key_str] = Resample(adaptive_sample_rate, enhancer_sample_rate,
                                                         lowpass_filter_width=128).to(self.device)
