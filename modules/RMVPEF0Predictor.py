...
class RMVPEF0Predictor():
    def __init__(self,hop_length=512,f0_min=50,f0_max=1100, dtype=torch.float32, device=None,sampling_rate=44100,threshold=0.05):
        self.rmvpe = RMVPE(model_path="pretrain/rmvpe/rmvpe.pt",dtype=dtype,device=device)
    ...
    def compute_f0(self,wav,p_len=None):
        ...
        print("f0 predictor(rmvpe) use time:{}".format(use_time))
    ...
    def compute_f0_uv(self,wav,p_len=None):
        ...
        if torch.all(f0 == 0):
            ...
            return rtn,rtn
        use_time = time.time() - start
        print("f0/uv predictor(rmvpe) use time:{}".format(use_time))
